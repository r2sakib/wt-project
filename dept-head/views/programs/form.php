            ...
            <form action="controllers/ProgramController.php" method="POST" id="program-form">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="total_credit_hours" name="total_credit_hours" placeholder="e.g., 148" min="1" required>
                    </div>
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="description" name="description" rows="4" placeholder="Briefly describe the program objectives and scope..."></textarea>
                </div>
