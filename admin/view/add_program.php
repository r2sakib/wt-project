...
<body>
    <div class="container">
        ...
        <form action="../controller/ProgramController.php" method="POST">
            ...
            <input type="text" name="code" required placeholder="e.g. BSc CS">
            
            <div class="row">
                <div class="col">
                    <label>Total Credit Hours:</label>
                    <input type="number" name="total_credit_hours" required min="1" placeholder="e.g. 140" style="width: 100%; padding: 8px; border: 1px solid #ccc; border-radius: 4px;">
                </div>
                <div class="col">
